...
import { Plus, Edit, Trash2, MapPin, DollarSign, Briefcase, Users, Eye } from 'lucide-react';
      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Create and manage job opportunities for drivers</p>
          </div>
          ...
          <Dialog open={showDialog} onOpenChange={setShowDialog}>
            ...
            <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  {editingJob ? 'Update the job details below' : 'Fill in the job information to create a new posting'}
                </DialogDescription>
              </DialogHeader>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-success-600">{jobs.filter(j => j.status === 'active').length}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-warning-600">{profiles.filter(p => p.status === 'approved' || p.status === 'employee').length}</p>
                </div>
        ...
        {jobs.length === 0 ? (
          <Card className="job-card">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Create your first job posting to start attracting qualified truck drivers to your company.
              </p>
              <Button onClick={handleCreate} className="bg-brand-600 hover:bg-brand-700">
                <Plus className="h-4 w-4 mr-2" />
          ...
          <div className="grid gap-6">
            {jobs.map((job) => (
              <Card key={job.id} className="job-card shadow-soft hover:shadow-medium transition-shadow">
                <CardHeader>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <Badge 
                          ...
                          className={job.status === 'active' ? 'bg-success-600' : 'bg-gray-500'}
                        >
                          {job.status}
                        </Badge>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                        ...
                        <div className="flex items-center space-x-2">
                          <Badge className={getJobTypeColor((job as any).type || 'full-time')}>
                            {(job as any).type || 'Full Time'}
                          </Badge>
                          <Badge className={getExperienceColor((job as any).experience || 'entry')}>
